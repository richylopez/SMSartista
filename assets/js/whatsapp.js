...
$form.addEventListener('submit', (event) => {
    ...
    setTimeout(() => {
        ...
        let message = 'send?phone=' + phone + '&text=*_SOLICITUD DE BUSQUEDAD DE ARTISTAS_*%0A*(Datos del Solicitante)*%0A%0A*¿Nombre Del Solicitante?*%0A' 
        + Nombre + '%0A*¿Celular de Contacto?*%0A' + Celular + '%0A*¿Zona del Trabajo?*%0A' + Zona + '%0A*¿Dirección del Trabajo?*%0A' + Direccion + 
        '%0A*¿Tipo de Servicio?*%0A' + Servicio1 +' *:* ' + Servicio2 + '%0A*¿Requisitos para el trabajo?*%0A' + Requisitos +
